...
<i>Hi there, thank you for your interest! We are currently preparing the clean version of our codebase, including demo scripts and instructions. The repository will be updated shortly after CVPR25. Stay tuned!</i>
...
<p align="center">
  <img src="media/CVPRW25_main_diagram.png" width="100%" alt="Pull Figure of CAMEL">
</p>
...
## Datasets
Download [SportsMOT](https://github.com/MCG-NJU/SportsMOT), [DanceTrack](https://github.com/DanceTrack/DanceTrack), [SoccerNet-tracking 2022](https://www.soccer-net.org/data) and [MOT17](https://motchallenge.net/), and place them inside the data/ folder.
...
## Evaluation
Run the script the get the tracking output and then use [TrackEval](https://github.com/JonathonLuiten/TrackEval) to obtain the performance numbers.
```
...
## Demo 
Run the following file with arguments as described below.
```
